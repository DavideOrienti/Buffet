...
//                .antMatchers(HttpMethod.GET, "/", "/index", "/login", "/register", "/css/**", "/images/**","/collezione/**","/artisti/**","/opera/**","/artista/**","/").permitAll()
//                // chiunque (autenticato o no) può mandare richieste POST al punto di accesso per login e register 
//                .antMatchers(HttpMethod.POST, "/login", "/register").permitAll()
//                // solo gli utenti autenticati con ruolo ADMIN possono accedere a risorse con path /admin/**
//                .antMatchers(HttpMethod.GET, "/admin/**","/addArtista/**","/addCuratore/**","/addCollezione/**","/addOpera/**").hasAnyAuthority(ADMIN_ROLE)
//                .antMatchers(HttpMethod.POST, "/admin/**","/collezioni/**","/artisiti").hasAnyAuthority(ADMIN_ROLE)
